...
# ╔═╡ 0a6b6faa-bfd9-11ec-2df2-a1c59098762a
using LinearAlgebra, BenchmarkTools, CUDA, LoopVectorization

# ╔═╡ 4fc1b97c-4c74-4588-89c0-a0e476e8d21f
begin
	using Plots
...
# ╔═╡ 29127445-0751-451e-97f8-702f6081054d
begin
	using SimpleChains
	mlpd = SimpleChain(
	  static(4),
...
# ╔═╡ 80dfbc15-aae5-4a9b-8e53-8df437087858
begin
	using  MLDatasets
...
# ╔═╡ 61073a31-a0a4-4a5d-a32d-d5cc0976e896
...
# ╔═╡ f7262907-baa6-4506-8573-b25004170113
begin
...
# ╔═╡ 6eff48c7-4d88-4a55-8ee9-dc446222e45c
md"""
SimpleChains.jl example

The problem with the above solution is that it doesn't saturate the gpu chips so we have a bottleneck. GPUs excel at matrix-matrix multiplication, not so much for the O(n^2) matrix-vector multiplication or the sigma.(W*x .+ b) O(n) element operation.
"""

# ╔═╡ b7335d3c-2e64-451f-b056-6f235bdd2dc6
function f(x)
...
# ╔═╡ 24f4279a-76ff-45f5-8c65-6e85b1ba2710
begin
	T = Float32;
	D = 2 # 2x2 matrices
...
[[deps.SimpleChains]]
deps = ["ArrayInterface", "CPUSummary", "ChainRulesCore", "CloseOpenIntervals", "ForwardDiff", "HostCPUFeatures", "IfElse", "LayoutPointers", "LoopVectorization", "ManualMemory", "Polyester", "Random", "SIMDTypes", "SLEEFPirates", "Static", "StrideArraysCore", "UnPack", "VectorizationBase", "VectorizedRNG"]
git-tree-sha1 = "ff6811d98155b9f4ba9e3546f3846d9d46cee1cf"
...
git-tree-sha1 = "972de61ae8cb965c516b871b69bb8594463d39a9"
...
git-tree-sha1 = "975d20216e8647f98c078b2023560577d4e29cdf"
